...
//eliminar calificación
        if(isset($_POST['delete'])&&($_POST['delete']=='yes')){
            $query="delete from calificaciones where proyecto_id = '$idProyecto'";//elimino calificación
            $result=mysqli_query($con_mysql,$query)or die('ERROR:'.mysqli_error());
            $query="delete from proyectos where id = '$idProyecto'";//elimino proyecto ya que es único y no quiero que aparezca más
            $result=mysqli_query($con_mysql,$query)or die('ERROR:'.mysqli_error());
            if($result){
