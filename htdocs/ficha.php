...
if(isset($_POST['idAlumno'])){
    ...
    $query = "SELECT alumnado.alumno,alumnado.agrupamiento_id,agrupamientos.agrupamiento,agrupamientos.curso,agrupamientos.materia,agrupamientos.nivel FROM alumnado,agrupamientos WHERE alumnado.id='$idAlumno' and alumnado.agrupamiento_id=agrupamientos.id";
    ...
    if(mysqli_num_rows($result)>0){
        ...
        //la asistencia
        $queryAsistencia = "select * from asistencia where alumno_id = '$idAlumno'";
