    ...
    for($e=0;$e<$numEstandares;$e++){
        ...
        echo '<table border="1" style="border-collapse:collapse">';
            echo '<tr>';
                ...
                echo '<th style="width:10%;">5</th>';
                echo '<th style="width:10%;">4</th>';
                echo '<th style="width:10%;">3</th>';
                echo '<th style="width:10%;">2</th>';
                echo '<th style="width:10%;">1</th>';
            echo '</tr>';
            ...
            for($a=0;$a<$num;$a++){
                ...
                echo '<tr>';
                    ...
                    if($numSelect>0){
                        ...
                        $calificacionEstandarRubrica = round(($calificacionEstandar),0);
                        echo '<td style="text-align:center;">';
                            if($calificacionEstandarRubrica == 10){echo '<big><b>'.$calificacionEstandarRubrica.'</b></big>';echo '<br/>';echo '('.round($calificacionEstandar,2).')';}
                        echo '</td>';
                        echo '<td style="text-align:center;">';
                            if(($calificacionEstandarRubrica == 9)||($calificacionEstandarRubrica == 8)){echo '<big><b>'.$calificacionEstandarRubrica.'</b></big>';echo '<br/>';echo '('.round($calificacionEstandar,2).')';}
                        echo '</td>';
                        echo '<td style="text-align:center;">';
                            if(($calificacionEstandarRubrica == 7)||($calificacionEstandarRubrica == 6)){echo '<big><b>'.$calificacionEstandarRubrica.'</b></big>';echo '<br/>';echo '('.round($calificacionEstandar,2).')';}
                        echo '</td>';
                        echo '<td style="text-align:center;">';
        ...
        echo '<p style="font-size:8px">';
            echo '<span>5: Demuestra total comprensión del problema. Todos los requerimientos de la tarea están incluidos en la respuesta.</span><br/>';
            echo '<span>4: Demuestra considerable comprensión del problema. Todos los requerimientos de la tarea están incluidos en la respuesta.</span><br/>';
            echo '<span>3: Demuestra comprensión parcial del problema. La mayor cantidad de requerimientos de la tarea están comprendidos en la respuesta.</span><br/>';
